			...
			<div class="clearfix">
				<div class="fl">
					...
					<div class="footer-rights">
						©2019 Meizu Telecom Equipment Co., Ltd. All rights reserved.     粤ICP备13003602号 合字B2-20170010 营业执照 法律声明  粤公网安备 44049102496009 号 
					</div>
				</div>
	...
	export default {
		...
		methods: {
			async getExternalLinkData() {
				const {
					data
				} = await this.axios.get("http://localhost:8888/externalLink");
