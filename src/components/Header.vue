	...
	<div class="header">
		<div class="header-wrapper clearfix">
			...
			<ul class="header-nav fr">
				<li v-for="(item,index) in navData" :key='index' @mouseenter="showNavChildren(item)">
			...
			<div class="nav-children" v-show="NavDataChildrenshow" @mouseleave="NavDataChildrenHide">
				<div class="children-wrapper">
					<transition-group tag='ul' @enter='enter'>
						<li v-for="(item,index) in navDataChildren" :key='item.pic' :data-timeindex='index' class="childern-item">
