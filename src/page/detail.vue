        ...
        <div class="detail-wrapper">
            ...
            <div class="clearfix">
                ...
                <div class="fl detail-props">
                    ...
                    <p class="props-desc">{{goodsDetailData.goodsDesc}}123213</p>
                    ...
                    <div>
                        ...
                        <ul>
                            <li>
                                <i class="icon-font icon-check-circle">百城速达</i>
                            </li>
                            <li>
                                <i class="icon-font icon-check-circle">顺丰包邮</i>
                            </li>
                            <li>
                                <i class="icon-font icon-check-circle">七天无理由退货</i>
                            </li>
                        </ul>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div class="clearfix props-number">
                            <input class="props-input fl" type="text">
                            <div class="props-box fl">
                    ...
                    <div class="props-buy">
                        <a class="btn danger br">立即购买</a>
                        <a class="btn success">加入购物车</a>
                    </div>
                </div>
            </div>
        </div>
